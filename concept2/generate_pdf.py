#!/usr/bin/env python3
"""
concept2/generate_pdf.py — Generador híbrido D&D 2024 (PyMuPDF + CaslonAntique).

Combina lo mejor de los dos enfoques previos:
  • concept/generate_pdf.py : PyMuPDF, preserva AP originales del template
    (círculos teal ZaDb, fondos azules de conjuros, estrella ☆ de inspiración).
  • scripts/fill_pdf.py     : CaslonAntique inyectada en AcroForm /DR y AP
    streams de texto construidos manualmente — tipografía medieval coherente.

Resultado: fidelidad visual del template + texto en CaslonAntique.
...
Uso:
    venv/Scripts/python concept2/generate_pdf.py
    venv/Scripts/python concept2/generate_pdf.py data/personaje.json output/salida.pdf
    venv/Scripts/python concept2/generate_pdf.py -v --verify
...
DEFAULT_OUT   = PROJECT_ROOT / "output" / "concept2_output.pdf"
...
# ---------------------------------------------------------------------------
# Checkbox helpers (de concept/generate_pdf.py)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Parche de color teal en checkboxes ZaDb (de concept/generate_pdf.py)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Espacio de conjuro: preservar fondo azul circular (de concept/generate_pdf.py)
# ---------------------------------------------------------------------------
